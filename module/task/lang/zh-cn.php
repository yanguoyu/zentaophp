 ...
 */
$lang->task->index               = "子任务一览";
$lang->task->create              = "建子任务";
$lang->task->batchCreate         = "批量创建";
$lang->task->batchCreateChildren = "批量建细分任务";
$lang->task->batchEdit           = "批量编辑";
$lang->task->batchChangeModule   = "批量修改模块";
$lang->task->batchClose          = "批量关闭";
$lang->task->batchCancel         = "批量取消";
$lang->task->edit                = "编辑子任务";
$lang->task->delete              = "删除";
$lang->task->deleteAction        = "删除子任务";
$lang->task->deleted             = "已删除";
$lang->task->delayed             = '延期';
$lang->task->view                = "查看子任务";
$lang->task->logEfforts          = "记录工时";
$lang->task->record              = "工时";
$lang->task->start               = "开始";
$lang->task->startAction         = "开始子任务";
$lang->task->restart             = "继续";
$lang->task->restartAction       = "继续子任务";
$lang->task->finishAction        = "完成子任务";
$lang->task->finish              = "完成";
$lang->task->pause               = "暂停";
$lang->task->pauseAction         = "暂停子任务";
$lang->task->close               = "关闭";
$lang->task->closeAction         = "关闭子任务";
$lang->task->cancel              = "取消";
$lang->task->cancelAction        = "取消子任务";
$lang->task->activateAction      = "激活子任务";
$lang->task->activate            = "激活";
$lang->task->export              = "导出数据";
$lang->task->exportAction        = "导出子任务";
...
$lang->task->copy                = '复制子任务';
$lang->task->waitTask            = '未开始的子任务';
$lang->task->allModule           = '所有模块';

$lang->task->common           = '子任务列表';
$lang->task->id               = '编号';
...
$lang->task->name             = '子任务名称';
$lang->task->type             = '子任务类型';
$lang->task->pri              = '优先级';
...
$lang->task->date             = '日期';
$lang->task->deadline         = '预计完成日期';
$lang->task->deadlineAB       = '截止';
$lang->task->status           = '子任务状态';
$lang->task->subStatus        = '子状态';
$lang->task->desc             = '子任务描述';
$lang->task->assign           = '指派';
$lang->task->assignAction     = '指派子任务';
...
$lang->task->multiple         = '多人子任务（不要勾选）';
$lang->task->multipleAB       = '多人';
$lang->task->team             = '团队';
$lang->task->transfer         = '转交';
$lang->task->transferTo       = '转交给';
$lang->task->children         = '子任务细分';
$lang->task->childrenAB       = '细分';
$lang->task->parent           = '父任务（不要选）';
...
$lang->task->ditto             = '同上';
$lang->task->dittoNotice       = "该子任务与上一子任务不属于同一任务！";
...
$lang->task->yesterdayFinished = '昨日完成子任务数';
$lang->task->allTasks          = '总子任务';
...
$lang->task->afterChoices['continueAdding'] = "继续为该{$lang->storyCommon}添加子任务";
$lang->task->afterChoices['toTaskList']     = '返回子任务列表';
$lang->task->afterChoices['toStoryList']    = "返回{$lang->storyCommon}列表";

$lang->task->legendBasic  = '基本信息';
$lang->task->legendEffort = '工时信息';
$lang->task->legendLife   = '子任务的一生';
$lang->task->legendDesc   = '子任务描述';

$lang->task->confirmDelete         = "您确定要删除这个子任务吗？";
...
$lang->task->remindBug             = "该子任务为Bug转化得到，是否更新Bug:%s ?";
$lang->task->confirmChangeProject  = "修改{$lang->projectCommon}会导致相应的所属模块、相关{$lang->storyCommon}和指派人发生变化，确定吗？";
$lang->task->confirmFinish         = '"预计剩余"为0，确认将子任务状态改为"已完成"吗？';
$lang->task->confirmRecord         = '"剩余"为0，子任务将标记为"已完成"，您确定吗？';
$lang->task->confirmTransfer       = '"当前剩余"为0，子任务将被转交，您确定吗？';
$lang->task->noticeLinkStory       = "没有可关联的相关{$lang->storyCommon}，您可以为当前任务%s，然后%s";
$lang->task->noticeSaveRecord      = '您有尚未保存的工时记录，请先将其保存。';
$lang->task->commentActions        = '%s. %s, 由 <strong>%s</strong> 添加备注。';
$lang->task->deniedNotice          = '当前子任务只有%s才可以%s。';
$lang->task->noTask                = '暂时没有子任务。';
$lang->task->createDenied          = '你不能在该任务添加子任务';
$lang->task->cannotDeleteParent    = '不能删除子任务（父）。';
...
$lang->task->error->consumedThisTime = '请填写"本次消耗"工时';
$lang->task->error->left             = '请填写"预计剩余"工时';
$lang->task->error->work             = '"备注"必须小于%d个字符';
$lang->task->error->workEmpty        = '请填写"备注"，阐述具体工作内容。';
$lang->task->error->dateEmpty        = '请选择"日期"';
$lang->task->error->skipClose        = '子任务：%s 不是“已完成”或“已取消”状态，确定要关闭吗？';
$lang->task->error->consumed         = '子任务：%s工时不能小于0，忽略该子任务工时的改动';
$lang->task->error->assignedTo       = '当前状态的多人子任务不能指派给子任务团队外的成员。';
$lang->task->error->consumedEmpty    = '"本次消耗"不能为空';
$lang->task->error->deadlineSmall    = '"预计完成日期"必须大于"预计开始"';
$lang->taskestimate->date            = '日期';
$lang->taskestimate->consumed        = '已消耗工时';
$lang->taskestimate->left            = '预计剩余工时';
...
$lang->task->report->value  = '子任务数';

$lang->task->report->charts['tasksPerProject']      = '按' . $lang->projectCommon . '子任务数统计';
$lang->task->report->charts['tasksPerModule']       = '按模块子任务数统计';
$lang->task->report->charts['tasksPerAssignedTo']   = '按指派给统计';
$lang->task->report->charts['tasksPerType']         = '按子任务类型统计';
$lang->task->report->charts['tasksPerPri']          = '按优先级统计';
$lang->task->report->charts['tasksPerStatus']       = '按子任务状态统计';
$lang->task->report->charts['tasksPerDeadline']     = '按预计完成日期统计';
