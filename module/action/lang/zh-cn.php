...
$lang->action->objectTypes['task']        = '子任务';
...
$lang->action->desc->changewillend  = '$date, 由 <strong>$actor</strong> 修改了预计完成时间。' . "\n";
...
/* 用来描述和父子任务相关的操作历史记录。*/
$lang->action->desc->createchildren     = '$date, 由 <strong>$actor</strong> 创建子（子任务） <strong>$extra</strong>。' . "\n";
$lang->action->desc->linkchildtask      = '$date, 由 <strong>$actor</strong> 关联子（子任务） <strong>$extra</strong>。' . "\n";
$lang->action->desc->linkchildtask      = '$date, 由 <strong>$actor</strong> 关联子（子任务) <strong>$extra</strong>。' . "\n";
$lang->action->desc->unlinkchildrentask = '$date, 由 <strong>$actor</strong> 移除子（子任务） <strong>$extra</strong>。' . "\n";
$lang->action->desc->linkparenttask     = '$date, 由 <strong>$actor</strong> 关联到子（父任务） <strong>$extra</strong>。' . "\n";
$lang->action->desc->unlinkparenttask   = '$date, 由 <strong>$actor</strong> 从子（父任务）<strong>$extra</strong>取消关联。' . "\n";
$lang->action->desc->deletechildrentask = '$date, 由 <strong>$actor</strong> 删除子（子任务）<strong>$extra</strong>。' . "\n";
...
$lang->action->label->linkchildtask       = "关联子（子任务）";
$lang->action->label->unlinkchildrentask  = "取消关联子（子任务）";
$lang->action->label->linkparenttask      = "关联到子（父任务）";
$lang->action->label->unlinkparenttask    = "从子（父任务）取消关联";
$lang->action->label->batchcreate         = "批量创建任务";
$lang->action->label->createchildren      = "创建子（子任务）";
$lang->action->label->managed             = "维护";
$lang->action->label->deletechildrentask  = "删除子（子任务）";
...
$lang->action->dynamicAction->story['unlinkedfromproject'] = '移除任务';
...
$lang->action->dynamicAction->project['moved']             = '导入子任务';
$lang->action->dynamicAction->task['opened']               = '创建子任务';
$lang->action->dynamicAction->task['edited']               = '编辑子任务';
$lang->action->dynamicAction->task['commented']            = '备注子任务';
$lang->action->dynamicAction->task['assigned']             = '指派子任务';
$lang->action->dynamicAction->task['confirmed']            = "确认{$lang->storyCommon}变更";
$lang->action->dynamicAction->task['started']              = '开始子任务';
$lang->action->dynamicAction->task['finished']             = '完成子任务';
...
$lang->action->dynamicAction->task['paused']               = '暂停子任务';
$lang->action->dynamicAction->task['closed']               = '关闭子任务';
$lang->action->dynamicAction->task['canceled']             = '取消子任务';
$lang->action->dynamicAction->task['activated']            = '激活子任务';
$lang->action->dynamicAction->task['createchildren']       = '创建子（子任务）';
$lang->action->dynamicAction->task['unlinkparenttask']     = '从子（父任务）取消关联';
$lang->action->dynamicAction->task['deletechildrentask']   = '删除子任务';
$lang->action->dynamicAction->task['linkparenttask']       = '关联到子（父任务）';
$lang->action->dynamicAction->task['linkchildtask']        = '关联子任务';
$lang->action->dynamicAction->task['undeleted']            = '还原子任务';
$lang->action->dynamicAction->task['hidden']               = '隐藏子任务';
...
$lang->action->dynamicAction->bug['totask']                = '转子任务';
...
$lang->action->label->task        = '子任务|task|view|taskID=%s';
...
$lang->action->search->objectTypeList['task']        = '子任务';
