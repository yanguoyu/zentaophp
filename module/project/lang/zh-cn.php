...
$lang->project->allSprintProjects   = '所有任务';
$lang->project->allNotSprintProjects   = '所有项目';
$lang->project->type          = $lang->projectCommon . '类型';
$lang->project->name          = $lang->projectCommon . '名称';
$lang->project->code          = $lang->projectCommon . '编号';
...
$lang->project->all           = '所有';
$lang->project->noconfirm     = '待确认';
$lang->project->willEnd       = '预计完成日期';
...
$lang->project->readjustTask  = '顺延子任务的起止时间';
...
$lang->project->changewillend  = "预计完成";
$lang->project->cancel  = "取消";
$lang->project->activate = "激活";
$lang->project->putoff   = "延期";
$lang->project->suspend  = "暂停";
$lang->project->close    = "确认验收";
$lang->project->export   = "导出";

$lang->project->typeList['sprint']    = "模块研发类";
$lang->project->typeList['waterfall'] = "非模块研发类";
$lang->project->typeList['ops']       = "分中心内部$lang->projectCommon";
...
$lang->project->task              = '子任务列表';
$lang->project->groupTask         = '分组浏览子任务';
...
$lang->project->changewillendAction     = "预计完成{$lang->projectCommon}";
$lang->project->cancelAction      = "取消{$lang->projectCommon}";
...
$lang->project->suspendAction     = "暂停{$lang->projectCommon}";
...
$lang->project->treeTask          = '只看子任务';
$lang->project->treeStory         = "只看{$lang->storyCommon}";
$lang->project->treeOnlyTask      = '树状图只看子任务';
...
$lang->project->statusSelects['wait']         = '未启动';
...
$lang->project->statusSelects['closed']       = '已验收';
...
$lang->project->groupFilter['story']['linked']      = "已关联{$lang->storyCommon}的子任务";
...
$lang->project->taskSummary         = "本页共 <strong>%s</strong> 个子任务，未开始 <strong>%s</strong>，进行中 <strong>%s</strong>，总预计 <strong>%s</strong> 工时，已消耗 <strong>%s</strong> 工时，剩余 <strong>%s</strong> 工时。";
$lang->project->checkedSummary      = "选中 <strong>%total%</strong> 个子任务，未开始 <strong>%wait%</strong>，进行中 <strong>%doing%</strong>，总预计 <strong>%estimate%</strong> 工时，已消耗 <strong>%consumed%</strong> 工时，剩余 <strong>%left%</strong> 工时。";
...
$lang->project->countSummary        = '<div class="table-col"><div class="clearfix segments"><div class="segment"><div class="segment-title">总子任务</div><div class="segment-value">%s</div></div><div class="segment"><div class="segment-title">进行中</div><div class="segment-value"><span class="label label-dot label-primary"></span> %s</div></div><div class="segment"><div class="segment-title">未开始</div><div class="segment-value"><span class="label label-dot label-primary muted"></span> %s</div></div></div></div>';
...
$lang->project->groupSummaryAB      = "<div>总子任务 <strong>%s : </strong><span class='text-muted'>未开始</span> %s &nbsp; <span class='text-muted'>进行中</span> %s</div><div>总预计 <strong>%s : </strong><span class='text-muted'>已消耗</span> %s &nbsp; <span class='text-muted'>剩余</span> %s</div>";
$lang->project->wbs                 = "分解子任务";
...
$lang->project->linkStory             = "关联{$lang->storyCommon}";
$lang->project->createTask            = '创建子任务';
$lang->project->goback                = "返回子任务列表";
