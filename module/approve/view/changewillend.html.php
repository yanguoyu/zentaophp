  ...
  <form class='load-indicator main-form' method='post' target='hiddenwin'>
    <table class='table table-form'>
      <tbody>
        ...
        <tr>
          <th><?php echo $lang->approve->changewillend;?></th>
          <td>
            <?php echo html::input('willEnd', $project->willEnd, "class='form-control form-date' onchange='computeWorkDays()' placeholder='" . $lang->approve->willEnd . "'");?>
          </td>
        </tr>
        <tr>
