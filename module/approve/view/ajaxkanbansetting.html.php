    ...
    <div id='mainContent' class='main-content'>
      <div class='center-block'>
        <div class='main-header'>
          <h2><?php echo $lang->approve->kanbanSetting;?></h2>
        </div>
        <form target='hiddenwin' method='post'>
          <table class='table table-form'>
            <?php if(common::hasPriv('project', 'kanbanHideCols')):?>
            <tr class='statusTR'>
              <th class='text-right w-200px'><?php echo $lang->approve->kanbanHideCols?></th>
            ...
            <tr class='statusTR'>
              <th class='text-right'><?php echo $lang->approve->kanbanColsColor?></th>
              <td>
                <div class='row'>
            ...
            <tr>
              <td colspan='2' class='form-actions text-center'>
                ...
                echo '&nbsp;' . html::a(inlink('ajaxResetKanban', "projectID=$projectID"), $lang->approve->resetKanban, 'hiddenwin', "class='btn btn-wide'");
                ?>
              </td>
            </tr>
          </table>
