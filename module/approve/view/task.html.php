  ...
  <div class="btn-toolbar pull-left">
    ...
    foreach(customModel::getFeatureMenu('project', 'task') as $menuItem)
    {
        ...
        elseif($menuType == 'status')
        {
            ...
            $active         = '';
            if(isset($lang->approve->statusSelects[$taskBrowseType]))
            {
                $current = "<span class='text'>{$lang->approve->statusSelects[$taskBrowseType]}</span> <span class='label label-light label-badge'>{$pager->recTotal}</span>";
...
$(function()
{
    ...
    var checkedSummary = '<?php echo $lang->approve->checkedSummary?>';
