...
<div id='mainMenu' class='clearfix'>
  <div class='pull-left btn-toolbar'>
    <?php echo html::a($this->createLink('project', 'importTask', "project=$projectID"), "<span class='text'>{$lang->approve->importTask}</span>", '', "class='btn btn-link btn-active-text'");?>
    <div class='input-control input-group space w-150px'>
      <?php $projects = array(0 => $lang->approve->allProjects) + $projects;?>
      <span class='input-group-addon'><?php echo $lang->approve->selectProject;?></span>
...
<div id='mainContent'>
  <form class='main-table' method='post' target='hiddenwin' id='importTaskForm' data-ride='table'>
    <table class='table table-fixed'>
      <thead>
        <tr>
          ...
          <th class='w-150px'><?php echo $lang->approve->name ?></th>
    ...
    <div class='table-footer'>
      ...
      <div class="table-actions btn-toolbar show-always"><?php echo html::submitButton('<i class="icon icon-import icon-sm"></i> ' . $lang->approve->importTask, '', 'btn btn-secondary btn-wide');?></div>
    </div>
    <?php endif;?>
  </form>
</div>
