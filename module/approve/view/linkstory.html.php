...
<div id="mainMenu" class="clearfix">
  <div class="btn-toolbar pull-left">
    <span class='btn btn-link btn-active-text'><span class='text'><?php echo $lang->approve->linkStory;?></span></span>
  </div>
...
<div id="mainContent">
  ...
  <form class='main-table table-story' method='post' data-ride='table' id='linkStoryForm'>
    ...
    <div class="table-empty-tip">
      <p><span class="text-muted"><?php echo $lang->approve->whyNoStories;?></p>
    </div>
    <?php endif;?>
  </form>
</div>
