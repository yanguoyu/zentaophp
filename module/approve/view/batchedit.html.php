...
<div id='mainContent' class='main-content'>
  <div class='main-header'>
    <h2><?php echo $lang->approve->batchEdit;?></h2>
  ...
  foreach(explode(',', $config->approve->edit->requiredFields) as $field)
  {
      if($field)
      {
          $requiredFields[$field] = '';
          if(strpos(",{$config->approve->customBatchEditFields},", ",{$field},") !== false) $visibleFields[$field] = '';
      }
  }
      ...
      <table class='table table-form'>
        <thead>
          <tr>
            ...
            <th class='required <?php echo $minWidth?>'><?php echo $lang->approve->name;?></th>
            <th class='w-150px required'><?php echo $lang->approve->code;?></th>
            <th class='w-150px<?php echo zget($visibleFields, 'PM',     ' hidden') . zget($requiredFields, 'PM',     '', ' required');?>'><?php echo $lang->approve->PM;?></th>
            <th class='w-150px<?php echo zget($visibleFields, 'PO',     ' hidden') . zget($requiredFields, 'PO',     '', ' required');?>'><?php echo $lang->approve->PO;?></th>
            <th class='w-150px<?php echo zget($visibleFields, 'QD',     ' hidden') . zget($requiredFields, 'QD',     '', ' required');?>'><?php echo $lang->approve->QD;?></th>
            <th class='w-150px<?php echo zget($visibleFields, 'RD',     ' hidden') . zget($requiredFields, 'RD',     '', ' required');?>'><?php echo $lang->approve->RD;?></th>
            <th class='w-100px<?php echo zget($visibleFields, 'type',   ' hidden') . zget($requiredFields, 'type',   '', ' required');?>'><?php echo $lang->approve->type;?></th>
            <th class='w-100px<?php echo zget($visibleFields, 'status', ' hidden') . zget($requiredFields, 'status', '', ' required');?>'><?php echo $lang->approve->status;?></th>
            <th class='w-110px required'><?php echo $lang->approve->begin;?></th>
            <th class='w-110px required'><?php echo $lang->approve->end;?></th>
            <th class='w-150px<?php echo zget($visibleFields, 'desc', ' hidden') . zget($requiredFields, 'desc', '', ' required');?>'>    <?php echo $lang->approve->desc;?></th>
            <th class='w-150px<?php echo zget($visibleFields, 'teamname', ' hidden') . zget($requiredFields, 'teamname', '', ' required');?>'><?php echo $lang->approve->teamname;?></th>
            <th class='w-150px<?php echo zget($visibleFields, 'days',     ' hidden') . zget($requiredFields, 'days',     '', ' required');?>'><?php echo $lang->approve->days;?></th>
            <th class='w-80px'><?php echo $lang->approve->order;?></th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td class='<?php echo zget($visibleFields, 'type',   'hidden')?>'><?php echo html::select("types[$projectID]",    $lang->approve->typeList,   $projects[$projectID]->type,   'class=form-control');?></td>
            <td class='<?php echo zget($visibleFields, 'status', 'hidden')?>'><?php echo html::select("statuses[$projectID]", $lang->approve->statusList, $projects[$projectID]->status, 'class=form-control');?></td>
