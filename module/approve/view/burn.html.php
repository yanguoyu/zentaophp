...
<?php js::set('watermark', $lang->approve->watermark);?>
<?php js::set('type', $type);?>
<div id='mainMenu' class='clearfix'>
  <div class='btn-toolbar pull-left'>
    <?php
    $weekend = ($type == 'noweekend') ? 'withweekend' : "noweekend";
    common::printLink('project', 'computeBurn', 'reload=yes', '<i class="icon icon-refresh"></i> ' . $lang->approve->computeBurn, 'hiddenwin', "title='{$lang->approve->computeBurn}{$lang->approve->burn}' class='btn btn-primary' id='computeBurn'");
    echo '<div class="space"></div>';
    echo html::a($this->createLink('project', 'burn', "projectID=$projectID&type=$weekend&interval=$interval"), $lang->approve->$weekend, '', "class='btn btn-link'");
    common::printLink('project', 'fixFirst', "project=$project->id", $lang->approve->fixFirst, '', "class='btn btn-link iframe' data-width='700'");
    echo $lang->approve->howToUpdateBurn;
    ?>
    <?php if($interval):?>
...
<div id='mainContent' class='main-content'>
  <h2 class='text-center'><?php echo $projectName . ' ' . $this->lang->approve->burn;?></h2>
  <div id="burnWrapper">
    <div id="burnChart">
    ...
    <div id="burnLegend">
      <div class="line-ref"><div class='barline'></div><?php echo $lang->approve->charts->burn->graph->reference;?></div>
      <div class="line-real"><div class='barline bg-primary'></div><?php echo $lang->approve->charts->burn->graph->actuality;?></div>
    </div>
  </div>
</div>
<script>
