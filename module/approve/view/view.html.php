      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="panel block-burn" style="height: 280px">
            <div class="panel-heading">
              <div class="panel-title"><?php echo $project->name . $lang->approve->burn;?></div>
            ...
            <div class="panel-body">
              ...
              <div id="burnWrapper">
                ...
                <div id="burnYUnit">(<?php echo $lang->approve->workHour;?>)</div>
                <div id="burnLegend">
                  <div class="line-ref"><?php echo $lang->approve->charts->burn->graph->reference;?></div>
                  <div class="line-real"><?php echo $lang->approve->charts->burn->graph->actuality;?></div>
                </div>
              </div>
              <?php endif;?>
            </div>
        ...
        <div class="col-sm-6">
          <div class="panel block-dynamic" style="height: 280px">
            <div class="panel-heading">
              <div class="panel-title"><?php echo $lang->approve->latestDynamic;?></div>
              <nav class="panel-actions nav nav-default">
        ...
        <div class="col-sm-6">
          <div class="panel block-team" style="height: 240px">
            <div class="panel-heading">
              <div class="panel-title"><?php echo $lang->approve->relatedMember;?></div>
              <nav class="panel-actions nav nav-default">
            ...
            <div class="panel-body">
              <div class="row row-grid">
                ...
                <div class="col-xs-6"><i class="icon icon-person icon-sm text-muted"></i> <?php echo zget($users, $project->PM);?> <span class="text-muted">（<?php echo $lang->approve->PM;?>）</span></div>
                <?php endif;?>
                <?php if($project->PO):?>
                <?php $i--;?>
                <?php unset($teamMembers[$project->PO]);?>
                <div class="col-xs-6"><i class="icon icon-person icon-sm text-muted"></i> <?php echo zget($users, $project->PO);?> <span class="text-muted">（<?php echo $lang->approve->PO;?>）</span></div>
                <?php endif;?>
                <?php if($project->QD):?>
                <?php $i--;?>
                <?php unset($teamMembers[$project->QD]);?>
                <div class="col-xs-6"><i class="icon icon-person icon-sm text-muted"></i> <?php echo zget($users, $project->QD);?> <span class="text-muted">（<?php echo $lang->approve->QD;?>）</span></div>
                <?php endif;?>
                <?php if($project->RD):?>
                <?php $i--;?>
                <?php unset($teamMembers[$project->RD]);?>
                <div class="col-xs-6"><i class="icon icon-person icon-sm text-muted"></i> <?php echo zget($users, $project->RD);?> <span class="text-muted">（<?php echo $lang->approve->RD;?>）</span></div>
                <?php endif;?>
                <?php endif;?>
                ...
                <?php endforeach;?>
                <div class="col-xs-6">
                  <?php common::printLink('project', 'manageMembers', "projectID=$project->id", "<i class='icon icon-plus hl-primary text-primary'></i> &nbsp;" . $lang->approve->manageMembers, '', "class='text-muted'");?>
                </div>
                <?php endif;?>
              </div>
            </div>
        ...
        <div class="col-sm-6">
          <div class="panel block-docs" style="height: 240px">
            <div class="panel-heading">
            <div class="panel-title"><?php echo $lang->approve->doclib;?></div>
              <nav class="panel-actions nav nav-default">
          ...
          <div class="cell">
            <div class="detail">
              ...
              <div class="detail-content article-content">
                ...
                <p>
                  ...
                  <span class='label label-danger label-outline'><?php echo $lang->approve->deleted;?></span>
                  <?php endif; ?>
                  <span class="label label-primary label-outline"><?php echo zget($lang->approve->typeList, $project->type);?></span>
                  <?php if(isset($project->delay)):?>
                  <span class="label label-danger label-outline"><?php echo $lang->approve->delayed;?></span>
                  <?php else:?>
            ...
            <div class="detail">
              <div class="detail-title">
                <strong><?php echo $lang->approve->manageProducts;?></strong>
            ...
            <div class="detail">
              <div class="detail-title"><strong><?php echo $lang->approve->linkPlan;?></strong></div>
              <div class="detail-content">
                <div class="row row-grid">
                  <?php foreach($products as $productID => $product):?>
            ...
            <?php endif;?>
            <div class='detail'>
              <div class='detail-title'><strong><?php echo $lang->approve->lblStats;?></strong></div>
              <div class="detail-content">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td colspan="4">
                        ...
                        <?php echo $lang->approve->progress;?> <em><?php echo $progress . $lang->percent;?></em> &nbsp;
                    ...
                    <tr>
                      <th><?php echo $lang->approve->begin;?></th>
                      <td><?php echo $project->begin;?></td>
                      <th><?php echo $lang->approve->totalEstimate;?></th>
                      <td><em><?php echo $project->totalEstimate . $lang->approve->workHour;?></em></td>
                    </tr>
                    <tr>
                      <th><?php echo $lang->approve->end;?></th>
                      <td><?php echo $project->end;?></td>
                      <th><?php echo $lang->approve->totalConsumed;?></th>
                      <td><em><?php echo $project->totalConsumed . $lang->approve->workHour;?></em></td>
                    </tr>
                    <tr>
                      <th><?php echo $lang->approve->totalDays;?></th>
                      <td><?php echo $project->days;?></td>
                      <th><?php echo $lang->approve->totalLeft;?></th>
                      <td><em><?php echo $project->totalLeft . $lang->approve->workHour;?></em></td>
                    </tr>
                    <tr>
                      <th><?php echo $lang->approve->totalHours;?></th>
                      <td><em><?php echo $project->totalHours . $lang->approve->workHour;?></em></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="detail">
              <div class="detail-title"><strong><?php echo $lang->approve->basicInfo;?></strong></div>
              <div class="detail-content">
            ...
            <div class="detail">
              <div class="detail-title"><strong><?php echo $lang->approve->acl;?></strong></div>
              <div class="detail-content">
                <p><?php echo $lang->approve->aclList[$project->acl];?></p>
