  ...
  <form class='load-indicator main-form' method='post' target='hiddenwin'>
    <table class='table table-form'>
      <tbody>
        ...
        <tr>
          <th><?php echo $lang->approve->QD;?></th>
          <td colspan='2'>
        ...
        <tr>
          <th><?php echo $lang->approve->RD;?></th>
          <td colspan='2'>
        ...
        <tr>
          <td colspan='3' class='text-center form-actions'><?php echo html::submitButton($lang->approve->confirm) . ' ' .  html::linkButton($lang->goback, $this->session->taskList, 'self', '', 'btn btn-wide'); ?></td>
        </tr>
      </tbody>
    </table>
  </form>
