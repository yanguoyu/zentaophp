...
$config->message->objectTypes['project']     = array('opened', 'edited', 'managed','changewillend','started', 'confirm', 'delayed', 'canceled','suspended', 'closed', 'activated', 'undeleted','commented');
$config->message->objectTypes['task']        = array('opened', 'edited', 'commented', 'assigned', 'recordestimate','confirmed', 'started', 'finished', 'paused', 'canceled', 'restarted', 'closed', 'activated');
